...
public class BookLoanPageLoan extends javax.swing.JPanel {
    ...
    /**
     * Creates new form BookLoanPageLoan
     */

    Books listBooks = new Books();
    BooksLoan listBookLoan = new BooksLoan();
    ...
    private void initComponents() {
        ...
        background.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 92, 770, 380));

        jPanel1.setBackground(new java.awt.Color(51, 51, 51));

        jLabel2.setFont(new java.awt.Font("Roboto Black", 2, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Prestamos de libros del buho");
        ...
        background.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 490, -1, -1));
        ...
        background.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 540, 190, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(tableColumnModel.getValueAt(row, 6).equals("true")){
            ...
            booktemp.append(tableColumnModel.getValueAt(row, 0)).append(",").append(tableColumnModel.getValueAt(row, 1)).append(",").append(tableColumnModel.getValueAt(row, 2)).append(",").append(tableColumnModel.getValueAt(row, 3)).append(",").append(tableColumnModel.getValueAt(row, 4)).append(",").append(tableColumnModel.getValueAt(row, 5)).append(",").append(tableColumnModel.getValueAt(row, 6));
            ...
            JOptionPane.showMessageDialog(null, "¡Hola! Este es un mensaje informativo.", "Información", JOptionPane.INFORMATION_MESSAGE);
        }
